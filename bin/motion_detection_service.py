...
class MotionDetectionService:
    ...
    def _setup_gpio(self):
        ...
        try:
            ...
            GPIO.setup(self.motion_sensor_pin, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
    ...
    def _start_motion_detection(self):
        ...
        if self.test_mode:
            ...
            test_thread = threading.Thread(target=test_motion_simulator, daemon=True)
            test_thread.start()
    ...
    def start_display_timer(self):
        ...
        print(f"⏰ Display timer started ({self.display_timeout}s until dimming)")
    ...
    def _on_display_timeout(self):
        ...
        print(f"⏰ Dimming timer started ({self.display_dimming_timeout}s until off)")
